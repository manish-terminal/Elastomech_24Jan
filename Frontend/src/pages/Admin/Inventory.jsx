...
const Inventory = () => {
  ...
  const filteredRubberIngredients = rubberIngredients.filter((item) =>
  ...
  return (
    <div className="inventory-page p-6 bg-gray-100 min-h-screen">
      ...
      {/* Search bar */}
      <motion.div
        className="search-bar mb-6 m-4 p-4 bg-white shadow-lg rounded-lg max-w-lg mx-auto"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5 }}
      >
        <input
          ...
          className="w-full rounded-lg border border-gray-300 bg-gray-100 py-2 px-4 text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </motion.div>
